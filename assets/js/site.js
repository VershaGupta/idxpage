...
function validateSignUpForm() {
    var signUpFormName = "signupForm";
    
    var name = document.forms[signUpFormName]["name"].value.trim();
    var email = document.forms[signUpFormName]["email"].value.trim();
    var password = document.forms[signUpFormName]["password"].value;
    var confirmpassword = document.forms[signUpFormName]["passwordconfirm"].value;
    ...
    if(nameReason == undefined && emailReason == undefined && passwordReason == undefined && passwordConfirmReason == undefined) {
        $("form[name='"+signUpFormName+"']")[0].submit();
        
    } else {
        
        var nameError = $("form[name='"+signUpFormName+"'] .nameError");
        ...
        var emailError = $("form[name='"+signUpFormName+"'] .emailError");
        ...
        var passwordError = $("form[name='"+signUpFormName+"'] .passwordError");
        ...
        var passwordConfirmError = $("form[name='"+signUpFormName+"'] .passwordConfirmError");
