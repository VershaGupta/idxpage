...
var LoginRadiusDefaults = {
  ...
  */
  ...
  configApiDomain: 'https://devcloud-api.lrinternal.com/configuration/ciam/',
  ...
  messages: {
    ...
    twofaGAAuthDisable: {
      ...
      'Description': 'Google authenticator is already disabled.'
    },
    twofaOTPAuthDisable: {
      'Message': 'Already Disabled',
  ...
  buttonNames: {
    ...
    googleauthenticator: 'Verify Identity via Google authenticator app',
...
function LoginRadiusUtility(module, optionsList) {
        ...
        if (projectionFieldsKeys.indexOf(action) !== -1 || mapActionsExist) {
          ...
          if (actionProjectionFields && actionProjectionFields.length > 0) {
            ...
            if (module.options.twoFactorAuthentication || module.options.optionalTwoFactorAuthentication) {
              requiredProjectedField.push('SecondFactorAuthentication/SecondFactorAuthenticationToken', 'SecondFactorAuthentication/IsOTPAuthenticatorVerified', 'SecondFactorAuthentication/IsGoogleAuthenticatorVerified', 'SecondFactorAuthentication/OTPPhoneNo', 'SecondFactorAuthentication/ManualEntryCode');
            }
  ...
  */
  utilityModule.addRecaptchaJS = function (add) {
    if (!window['grecaptcha'] && (module.options.v2Recaptcha || add)) {
      if (module.options.v2RecaptchaLanguage) {
        utilityModule.addJs('https://www.google.com/recaptcha/api.js?render=explicit&hl=' + module.options.v2RecaptchaLanguage);
      } else {
        utilityModule.addJs('https://www.google.com/recaptcha/api.js?render=explicit');
      }
    } else if (!window['grecaptcha'] && module.options.invisibleRecaptcha) {
      utilityModule.addJs('https://www.google.com/recaptcha/api.js');
    }
  ...
  */
  utilityModule.renderV2Recaptcha = function (recaptchaid, add, callback) {
    ...
    if (module.options.v2Recaptcha || add || module.options.invisibleRecaptcha || module.options.tencentCaptcha || module.options.tencentCaptchaAsFallback) {
          ...
          intval = setInterval(function () {
            if (window.grecaptcha) {
              if (domRecaptcha && domRecaptcha.innerHTML === '') {
                var recaptchaObj = {
                  'sitekey': module.options.v2RecaptchaSiteKey || '6LeAiwITAAAAADlqb06JIGepBs8ZRo3OZ7C0W7U3',
                  'theme': 'light',
  ...
  */
  utilityModule.captchaSchema = function (recaptchaid, schema, add, callabck) {
    if ((module.options.v2Recaptcha || add) && !utilityModule.elementById(recaptchaid)) {
      ...
      var sitekey = module.options.v2RecaptchaSiteKey || '6LeAiwITAAAAADlqb06JIGepBs8ZRo3OZ7C0W7U3';
      var style = '';
      if (add === 'hide') {
        style = 'display:none';
      }
      var invisibleCaptchaObj = {
        type: 'captcha',
        name: 'g-recaptcha-response',
...
function LoginRadiusApiFramework (module, controllers) {
  ...
  * @param  {String} data authenticatorType e.g. "otpauthenticator" or "googleauthenticator"
  * @param  {Function} onSuccess success callback function
  * @param  {Function} onError error callback function
 ...
 */
  ...
  */
  function mapOptions (appConfig) {
    ...
    if (appConfig.TwoFactorAuthentication.IsEnabled) {
      appData.optionalTwoFactorAuthentication = true;
      appData.twoFactorAuthentication = false;
      appData.googleAuthentication = appConfig.TwoFactorAuthentication.IsGoogleAuthenticator;
    ...
    lrOptions.otpEmailVerification = lrOptions.otpEmailVerification === undefined ? appConfig.OTPEmailVerification : lrOptions.otpEmailVerification;
    ...
    lrOptions.googleAuthentication = lrOptions.googleAuthentication === undefined ? appData.googleAuthentication : lrOptions.googleAuthentication;
    ...
    lrOptions.v2Recaptcha = lrOptions.v2Recaptcha === undefined ? appConfig.IsV2Recaptcha : lrOptions.v2Recaptcha;
    lrOptions.invisibleRecaptcha = lrOptions.invisibleRecaptcha === undefined ? appConfig.IsInvisibleRecaptcha : lrOptions.invisibleRecaptcha;
    ...
    lrOptions.tencentCaptchaAppid = lrOptions.tencentCaptchaAppid === undefined ? appConfig.QQTencentCaptchaKey : lrOptions.tencentCaptchaAppid;
  ...
  */
  function getAppConfiguration (callback) {
    ...
    //   callback = callback || function(){};
		  const organizationFormRender =  function (container, onSuccess, onError, classPrefix){
    ...
    if (!module.isApiCallingStarted  && !toRenderOrganization) {
		...
		module.isApiCallingStarted = false;
		 ...
		 if(module.useraction === "organization"){
			  organizationFormRender(module.currentActionOptions[module.useraction].container, function(){getAppConfiguration(function(){
				   var formElement = document.getElementsByName("loginradius-organization")[0];
			          formElement.remove();
					  module.currentActionOptions[module.useraction].onSuccess();
			  })} , module.currentActionOptions[module.useraction].onError || function(){}, module.currentActionOptions[module.useraction].classPrefix || "");
      ...
      if(module.options.isB2BEnabled && module.options.organization){
        url += "&organization="+module.options.organization;
      }
...
function LoginRadiusHooksModel (module) {
  ...
  */
  ...
  module.$hooks.register(
    'addFormCaptcha',
    function (container, callabck, type) {
      module.getAppConfiguration(function () {
        if (type) {
          module.options[type] = true;
        }
        var recaptchaid = container + 'recaptcha_widget';
  ...
  module.$hooks.register('successCallback', function (action, result, data) {
    ...
    if (result.ErrorCode == '1132') {
      if (module.LRCheckLogin || !module.LRCheck2FA) {
...
function SetLoginRadiusCommonFunctions(module) {
  ...
  */
  function handleFormResponse(form, onSuccess, recaptchaid, name) {
    ...
    if (window.grecaptcha && module.options.invisibleRecaptcha && domRecaptcha && domRecaptcha.innerHTML !== '' && domRecaptcha.style.display !== 'none') {
  ...
  */
  privateFunctionsModule.showQRCode = function (data, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField) {
    ...
    if (data.SecondFactorAuthentication) {
      ...
      if (!data.IsGoogleAuthenticatorVerified) {
        createQRSchema(qrCode, manualEntryCode);
      }
    }
  ...
  privateFunctionsModule.socialLogin = function (container, onSuccess, onError, _classPrefix) {
    ...
    if (!module.options.isMobile && !module.options.noCallbackForSocialLogin) {
      module.util.addEvent('message', window, function (event) {
        ...
        container = LoginRadiusDefaults.socialRegFormId || container;
        if (typeof event.data === 'string' && LoginRadiusDefaults._uuidFormat.test(event.data)) {
  ...
  privateFunctionsModule.resetPassword = function (container, onSuccess, onError, _classPrefix, fdata) {
      ...
      if (fdata) {
        ...
        if (!module.util.findInSchema(schema, 'name', 'resendotp')) {
          var resendBtnOTPSchema = Object.assign({}, module.btnOTPSchema, {
            name: 'resendotp',
            display: 'Resend Verification Code',
            eventCallback: function (event) {
              if (module.options.disableResendOTPButton) {
                module.util.disableResendOTPButton(event);
              }
              controllers.forgotPasswordbyPhoneController(LoginRadiusDefaults.LRPhoneNo, container, onSuccess, onError, _classPrefix, function () { /* do nothing. */ });
            }
          });
    ...
    privateFunctionsModule.createForm(schema, 'resetpassword', container, function (data) {
      if (data.indexOf('otp') !== -1 && !fdata) {
        controllers.resetPasswordByPhoneController(data + phoneNo, onSuccess, onError, container, _classPrefix);
      } else {
        if (fndata) {
          data += fndata;
        }
        ...
        if (!module.util.findInSchema(schema, 'name', 'resendotp')) {
          var resendBtnOTPSchema = Object.assign({}, module.btnOTPSchema, {
            ...
            eventCallback: function (event) {
              ...
              controllers.forgotPINbyPhoneController(LoginRadiusDefaults.LRPhoneNo, container, onSuccess, onError, _classPrefix, function () { /* do nothing. */ });
            }
          });
          schema.push(resendBtnOTPSchema);
        }
  ...
  */
  privateFunctionsModule.changeNumberForm = function (container, formElement, onSuccess, onError, _classPrefix, innerHtml, passwordExpiry, requiredField) {
    ...
    var disableMFA = emailotpAuth !== 'false' || gAuth !== 'false' || sqAuth !== 'false';
        ...
        if (module.setHostedToken || getSafariToken) {
          ...
          if (userProfile && !userProfile.EmailVerified && requiredEmailFlow && !oneTouchLogin) {
            ...
            if (userProfile.PhoneId) {
              ...
              controllers.resendOTPController(phoneObj, _onSuccess, onError, recaptchaid, container, _classPrefix);
            } else {
  ...
  */
  privateFunctionsModule.resendOTP = function (phoneData, container, onSuccess, onError, _classPrefix_, passwordExpiry, requiredField, updatePhone) {
    var phoneObj = {};
    ...
    module.util.addEvent('click', resendOTPBtn, function (event) {
      ...
      if (updatePhone) {
        ...
        if (token && privateFunctionsModule.isValidToken(token, onError)) {
          module.util.ajaxCall('put', LoginRadiusDefaults.apiDomain + '/auth/phone?apiKey=' + module.options.apiKey + '&access_token=' + token + '&smsTemplate=' + module.options.smsTemplateUpdatePhone, phoneObj, function (response) {
        ...
        privateFunctionsModule.resendOTPManually(phoneObj, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField);
      }
    });
  };
  /**
  ...
  */
  privateFunctionsModule.resendOTPManually = function (data, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField) {
    var recaptchaid = _classPrefix + LoginRadiusDefaults.idPrefix + 'recaptcha_widget_verifyotp';
    if (module.LRCheck2FA && (module.options.twoFactorAuthentication || module.options.optionalTwoFactorAuthentication) && !module.LRCheckRegistration) {
      if (module.storage.getBrowserStorage(LoginRadiusDefaults.storedOTPAuth) === 'false') {
        ...
        controllers.resendOTP2FAController(data, onSuccess, onError, recaptchaid, container, _classPrefix);
      }
    } else {
      controllers.resendOTPController(data, onSuccess, onError, recaptchaid, container, _classPrefix);
    }
  };
  /**
  * @memberof SetLoginRadiusCommonFunctions#
  ...
  */
  privateFunctionsModule.createForm = function (schema, name, container, onSuccess, onError, _classPrefixName) {
    var _idPrefix = _classPrefixName || LoginRadiusDefaults.idPrefix;
    var _classPrefix = _classPrefixName || LoginRadiusDefaults.classPrefix;
    var grecaptchaid;
    var enabledAuthAPIs;
    module.LRPrefix = _classPrefixName + '##' + LoginRadiusDefaults.idPrefix;
    if ((module.options.loginLockedType === 'Captcha' && name !== 'registration') || (module.options.optionalRecaptchaConfiguration && module.options.optionalRecaptchaConfiguration.IsEnabled)) {
      enabledAuthAPIs = module.options.optionalRecaptchaConfiguration.Apis;
      if (module.options.loginLockedType === 'Captcha' || (enabledAuthAPIs && isAddBotProtection(name, enabledAuthAPIs))) {
        ...
        var validator = new FormValidator(_idPrefix + name, validationSchema, function (errors, evt) {
          ...
          if (module.options.invisibleRecaptcha) {
            window.onCaptchaSubmit = function (response) {
              onSuccess(module.util.serialize(form));
              grecaptcha.reset(window[recaptchaid + 'lr_recaptcha_widgets_idprefix']);
            };
          }
          ...
          if (errors.length > 0) {
            ...
            for (var p = 0; p < errors.length; p++) {
              if ((errors[p].Id === _idPrefix + '' + name + '-password' && name === 'login' && ((module.options.passwordlessLogin && window['lrpasswordlesslogin']) || (module.options.passwordlessLoginOTP && window['lrpasswordlessloginotp'])))) {
    ...
    if ((module.options.optionalRecaptchaConfiguration && module.options.optionalRecaptchaConfiguration.IsEnabled && (enabledAuthAPIs && isAddBotProtection(name, enabledAuthAPIs))) && name !== 'registration') {
  ...
  privateFunctionsModule.resendOTPHandler = function (resendOtpArgs) {
    if (resendOtpArgs.action === 'update2FANumberResendOTP') {
      ...
      if (token && !module.LRCheckLogin) {
        module.util.ajaxCall('put', LoginRadiusDefaults.apiDomain + '/auth/account/2FA?apiKey=' + module.options.apiKey + '&access_token=' + token + '&smsTemplate=' + resendOtpArgs.smstemplate, resendOtpArgs.data, function (response) {
          if (response.ErrorCode) {
        ...
        module.util.ajaxCall('put', LoginRadiusDefaults.apiDomain + '/auth/login/2FA/?apiKey=' + module.options.apiKey + '&SecondFactorAuthenticationToken=' + twoFactorToken + '&smsTemplate2FA=' + resendOtpArgs.smstemplate, resendOtpArgs.data, function (response) {
          if (response.ErrorCode) {
            resendOtpArgs.onerror(privateFunctionsModule.loginRadiusErrorTojsError(response));
          } else {
            resendOtpArgs.onsuccess(response, resendOtpArgs.data);
      ...
      module.util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/login/otp?apiKey=' + module.options.apiKey + '&phone=' + resendOtpArgs.data + '&' + 'smsTemplate=' + resendOtpArgs.smstemplate, '', function (Response) {
        if (Response.ErrorCode) {
          resendOtpArgs.onerror(privateFunctionsModule.loginRadiusErrorTojsError(Response));
        } else {
      ...
      module.util.ajaxCall('GET', LoginRadiusDefaults.apiDomain + '/auth/login/passwordlesslogin/otp?apiKey=' + module.options.apiKey + '&' + resendOtpArgs.data + '&smsTemplate=' + resendOtpArgs.smstemplate, '', function (signinResponse) {
        if (signinResponse.ErrorCode) {
  ...
  privateFunctionsModule.addResendOTPBtn = function (flag, onSuccess, onError) {
    module.$hooks.register('afterFormRender', function (name, container, _classPrefix, form) {
      if (flag && form && form.name === 'loginradius-twofaemailotp') {
        if (!module.util.findInSchema(form, 'id', 'loginradius-button-resendotp')) {
          var resendOTPBtn = module.util.getButtonAttribute('resendotp', _classPrefix, function (event) {
            if (module.options.disableResendOTPButton) {
              module.util.disableResendOTPButton(event);
            }
...
function LoginRadiusControllers (module, commonFns) {
  ...
  * @param {String} authenticatorType authenticatorType e.g. "otpauthenticator" or "googleauthenticator"
  * @param {Function} onSuccess success callback function
  * @param {Function} onError error callback function
  ...
  controllersModule.forgotPasswordController = function (data, container, onSuccess, onError, _classPrefix) {
    ...
    module.util.ajaxCall('post', LoginRadiusDefaults.apiDomain + '/auth/password?apiKey=' + module.options.apiKey + '&resetPasswordUrl=' + resetPasswordUrl + '&emailTemplate=' + module.options.resetPasswordEmailTemplate, data, function (forgotPasswordResponse) {
      if (forgotPasswordResponse.ErrorCode) {
        ...
        if (module.options.otpEmailVerification && !module.options.verifyEmailByOTP) {
  ...
  */
  controllersModule.loginController = function (data, container, onSuccess, onError, passwordExpiry, requiredField, _classPrefix, verifyOTPApi, resendOTPApi) {
    ...
    if (module.options.riskBasedAuthentication) {
      template += '&RbaOneclickEmailTemplate=' + module.options.rbaOneclickEmailTemplate + '&RbaOTPSmsTemplate=' + module.options.rbaOTPSmsTemplate + '&RbaCityEmailTemplate=' + module.options.rbaCityEmailTemplate + '&RbaCountryEmailTemplate=' + module.options.rbaCountryEmailTemplate + '&RbaBrowserEmailTemplate=' + module.options.rbaBrowserEmailTemplate + '&RbaIpEmailTemplate=' + module.options.rbaIpEmailTemplate + '&RbaCitySmsTemplate=' + module.options.rbaCitySmsTemplate + '&RbaCountrySmsTemplate=' + module.options.rbaCountrySmsTemplate;
      template += '&RbaBrowserSmsTemplate=' + module.options.rbaBrowserSmsTemplate + '&RbaIpSmsTemplate=' + module.options.rbaIpSmsTemplate;
    }
    ...
    module.util.ajaxCall('post', url, data, function (loginResponse) {
      ...
      if (loginResponse.ErrorCode) {
        // eslint-disable-next-line eqeqeq
        if (loginResponse.ErrorCode == '970' && module.options.otpEmailVerification && !module.options.verifyEmailByOTP) {
          ...
          commonFns.resendOTP(data, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField);
        }
  ...
  controllersModule.loginOTPController = function (data, container, onSuccess, onError, _classPrefix, otpSent) {
    ...
    if (phoneData.email || phoneData.username) {
      ...
      if (otpSent) {
        ...
        module.util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/login/otp?apiKey=' + module.options.apiKey + '&phone=' + phoneData.phone + '&' + 'smsTemplate=' + smsTemplate, '', function (Response) {
          if (Response.ErrorCode) {
            onError(commonFns.loginRadiusErrorTojsError(Response));
          } else {
            onSuccess(Response);
  ...
  */
  controllersModule.login2FAController = function (data, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField, updatePhoneNumberApi, verifyOTPApi, resendOTPApi) {
    ...
    var handle2FAResponse = function (loginResponse, SecondFactorAuthentication) {
      ...
      var IsGoogleAuthenticatorVerified = SecondFactorAuthentication.IsGoogleAuthenticatorVerified || '';
      ...
      if (SecondFactorAuthentication.EmailOTPStatus === null && !IsOTPAuthenticatorVerified && !IsGoogleAuthenticatorVerified && !IsSecurityQuestionAuthenticatorVerified) {
        _sendotpapi = true;
      }
      ...
      var addBackBtn = function () {
        module.$hooks.register('afterFormRender', function (name, container, _classPrefix, form) {
          if (form && module.LRCheck2FA) {
            if (!module.util.findInSchema(form, 'id', 'loginradius-button-backupcodebackbutton')) {
      ...
      var twoFAemailotpCodeFn = function () {
        if (module.options.emailOTPAuthentication && ((!IsGoogleAuthenticatorVerified && !IsOTPAuthenticatorVerified && !IsSecurityQuestionAuthenticatorVerified && module.options.twoFactorAuthentication) || IsEmailOtpAuthenticatorVerified)) {
          if (loginResponse.SecondFactorAuthentication && loginResponse.SecondFactorAuthentication.Email && loginResponse.SecondFactorAuthentication.Email.length) {
            ...
            if (emails) {
              var emailOtpForm = function (emailid) {
                ...
                if (_sendotpapi || IsSecurityQuestionAuthenticatorVerified || IsGoogleAuthenticatorVerified || IsOTPAuthenticatorVerified) {
      ...
      var twoFAsecurityquestionCodeFn = function () {
        if (module.options.securityQuestionAuthentication && ((!IsEmailOtpAuthenticatorVerified && !IsGoogleAuthenticatorVerified && !IsOTPAuthenticatorVerified && module.options.twoFactorAuthentication) || IsSecurityQuestionAuthenticatorVerified)) {
          // var _innerHtml =  IsGoogleAuthenticatorVerified || IsEmailOtpAuthenticatorVerified || IsOTPAuthenticatorVerified;
      ...
      var twoFAgoogleauthCodeFn = function () {
        if (module.options.googleAuthentication && ((!IsEmailOtpAuthenticatorVerified && !IsOTPAuthenticatorVerified && !IsSecurityQuestionAuthenticatorVerified && module.options.twoFactorAuthentication) || IsGoogleAuthenticatorVerified)) {
      ...
      var twoFAsmsCodeFn = function () {
        if (!IsSecurityQuestionAuthenticatorVerified && !IsEmailOtpAuthenticatorVerified && !IsOTPAuthenticatorVerified && !IsGoogleAuthenticatorVerified && module.options.twoFactorAuthentication) {
          if (module.options.googleAuthentication || module.options.emailOTPAuthentication || module.options.securityQuestionAuthentication) {
          ...
          // eslint-disable-next-line no-eq-null
        } else if ((!IsSecurityQuestionAuthenticatorVerified && !IsGoogleAuthenticatorVerified && !IsEmailOtpAuthenticatorVerified && module.options.twoFactorAuthentication) || (module.options.optionalTwoFactorAuthentication && !IsOTPAuthenticatorVerified && !IsSecurityQuestionAuthenticatorVerified && !IsGoogleAuthenticatorVerified && !IsEmailOtpAuthenticatorVerified && (loginResponse.SecondFactorAuthentication.OTPPhoneNo !== '' && loginResponse.SecondFactorAuthentication.OTPPhoneNo != null)) || IsOTPAuthenticatorVerified) {
          _classPrefix = _classPrefix || LoginRadiusDefaults.classPrefix;
          var formElement = document.getElementsByName(_classPrefix + 'showQRcode')[0];

          if (module.options.googleAuthentication && formElement) {
      ...
      for (var key in authenticatorOptionsOrder) {
        if (authenticatorOptionsOrder[key]) {
          ...
          } else if (authenticatorOptionsOrder[key] === 'googleauth') {
            twoFAgoogleauthCodeFn();
          }
        }
      }
      if (IsSecurityQuestionAuthenticatorVerified || IsEmailOtpAuthenticatorVerified || IsOTPAuthenticatorVerified || IsGoogleAuthenticatorVerified) {
      ...
      module.util.addEvent('click', sendOTPBtn, function (event) {
        ...
        LoginRadiusDefaults.innerHTML = false;
        emailOtp = false;
        if (IsSecurityQuestionAuthenticatorVerified || IsGoogleAuthenticatorVerified || IsEmailOtpAuthenticatorVerified || _sendotpapi) {
          commonFns.resendOTPManually(phoneNo, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField);
        }
        ...
        commonFns.resendOTP(loginResponse, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField);
      });
    };
    ...
    module.util.ajaxCall(methodType, url, postBody, function (loginResponse) {
      ...
      if (loginResponse.ErrorCode) {
        ...
        if (module.options.phoneLogin && loginResponse.ErrorCode == '1066') {
          ...
          commonFns.resendOTP(phonetoVerify, container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField);
        }
  ...
  */
  controllersModule.resendOTPController = function (data, onSuccess, onError, recaptchaid, container, _classPrefix) {
    var templateName = data.updatePhone ? module.options.smsTemplateUpdatePhone : module.options.smsTemplatePhoneVerification;
    var url = LoginRadiusDefaults.apiDomain + '/auth/phone/otp?apiKey=' + module.options.apiKey + '&smsTemplate=' + templateName;
    var method = 'post';
    if (data.onetouchloginflag) {
      method = 'get';
      if (typeof data !== 'string') {
      ...
      url = LoginRadiusDefaults.apiDomain + '/auth/onetouchlogin/phone?apikey=' + module.options.apiKey + '&' + data + '&smstemplate=' + module.options.smsTemplatePhoneVerification;
    }
  ...
  */
  controllersModule.resendOTP2FAController = function (data, onSuccess, onError, recaptchaid, container, _classPrefix) {
    var twoFactorToken = module.storage.getBrowserStorage(LoginRadiusDefaults.storedTwoFAToken);
    var token = module.storage.getBrowserStorage(LoginRadiusDefaults.storedTokenName);
    if (token && !module.LRCheckLogin) {
      ...
      module.util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/login/2FA/resend?apiKey=' + module.options.apiKey + '&SecondFactorAuthenticationToken=' + twoFactorToken + '&smsTemplate2FA=' + module.options.smsTemplate2FA, '', function (response) {
        if (response.ErrorCode) {
          onError(commonFns.loginRadiusErrorTojsError(response));
        } else {
          module.log(defaultMessages['otpSent']);
  ...
  */
  controllersModule.verify2FAOTPController = function (data, onSuccess, onError, passwordExpiry, requiredField) {
    ...
    } else if ('googleauthenticatorcode' in _sendData) {
      twofaVerifyAction = 'googleauthenticatorcode';
    }
    if (token && !module.LRCheckLogin) {
      ...
      var template = '';
      if (module.options.riskBasedAuthentication) {
        template += '&RbaCityEmailTemplate=' + module.options.rbaCityEmailTemplate + '&RbaCountryEmailTemplate=' + module.options.rbaCountryEmailTemplate + '&RbaBrowserEmailTemplate=' + module.options.rbaBrowserEmailTemplate + '&RbaIpEmailTemplate=' + module.options.rbaIpEmailTemplate + '&RbaCitySmsTemplate=' + module.options.rbaCitySmsTemplate + '&RbaCountrySmsTemplate=' + module.options.rbaCountrySmsTemplate;
        template += '&RbaBrowserSmsTemplate=' + module.options.rbaBrowserSmsTemplate + '&RbaIpSmsTemplate=' + module.options.rbaIpSmsTemplate;
      }
      if (twofaVerifyAction === 'otp') {
        template += '&smsTemplate2FA=' + module.options.smsTemplate2FAWelcome;
      }
      if (twofaVerifyAction === 'googleauthenticatorcode') {
    ...
    if (commonFns.isValidToken(token, onError)) {
      module.util.ajaxCall('put', LoginRadiusDefaults.apiDomain + '/auth/phone?apiKey=' + module.options.apiKey + '&access_token=' + token + '&smsTemplate=' + module.options.smsTemplateUpdatePhone, data, function (response) {
        if (response.ErrorCode) {
          ...
          commonFns.resendOTP(data + '&updatePhone=true', container, onSuccess, onError, _classPrefix, passwordExpiry, requiredField, true);
          onSuccess(response, data);
        }
      }, 'updatePhone');
    }
  ...
  */
  controllersModule.forgotPasswordbyPhoneController = function (data, container, onSuccess, onError, _classPrefix, resetPasswordApi) {
    module.util.ajaxCall('post', LoginRadiusDefaults.apiDomain + '/auth/password/otp?apiKey=' + module.options.apiKey + '&smsTemplate=' + module.options.smsTemplateForgot, data, function (response) {
      if (response.ErrorCode) {
        onError(commonFns.loginRadiusErrorTojsError(response));
      } else {
        onSuccess(response, data);
  ...
  */
  controllersModule.forgotPINbyPhoneController = function (data, container, onSuccess, onError, _classPrefix, resetPINApi) {
    module.util.ajaxCall('post', LoginRadiusDefaults.apiDomain + '/auth/pin/forgot/otp?apiKey=' + module.options.apiKey + '&smsTemplate=' + module.options.smsTemplateForgot, data, function (response) {
      if (response.ErrorCode) {
        onError(commonFns.loginRadiusErrorTojsError(response));
      } else {
        onSuccess(response, data);
  ...
  */
  controllersModule.registrationController = function (data, container, onSuccess, onError, _classPrefix, regSchema, verifyOTPApi, resendOTPApi) {
    ...
    var template = 'emailTemplate=' + module.options.verificationEmailTemplate + '&verificationUrl=' + module.options.verificationUrl + '&welcomeEmailTemplate=' + module.options.welcomeEmailTemplate;
    if (module.options.phoneLogin) {
      template += '&smsTemplate=' + module.options.smsTemplatePhoneVerification;
    }
    ...
    var url = '';
    if (module.options.invisibleRecaptcha || module.options.v2Recaptcha || module.options.tencentCaptcha) {
      ...
      module.util.ajaxCall('post', url, registrationData, function (regResponse) {
        ...
        if (regResponse.ErrorCode) {
          ...
          if (module.options.phoneLogin && (typeof data === 'string' || data instanceof String) && data.indexOf('phoneid') !== -1) {
            ...
            commonFns.resendOTP(data, container, onSuccess, onError, _classPrefix);
          } else {
            var parseData = module.util.parseQueryString(data);
            if (module.options.disabledEmailVerification || module.options.optionalEmailVerification) {
              ...
              if (!module.options.disabledEmailVerification && (module.options.otpEmailVerification && !module.options.verifyEmailByOTP)) {
                module.$hooks.register('beforeFormRender', function (name, schema) {
                  if (name === 'otp' && !module.util.findInSchema(schema, 'name', 'skip')) {
                    addSkipFieldinSchema(schema);
                  }
  ...
  */
  controllersModule.oneTouchLoginController = function (data, container, onSuccess, onError, _classPrefix, useUpdatedAPI) {
    var formattedData = module.util.checkPhoneOrEmailLogin(data);
    var parsedData = module.util.parseQueryString(formattedData);
    var method = useUpdatedAPI ? 'POST' : 'GET';
    ...
    if (parsedData.phone) {
      ...
      if (useUpdatedAPI) {
        ...
        oneTouchPhoneURL = oneTouchPhoneURL + '&' + formattedData;
      }
      module.util.ajaxCall(method, oneTouchPhoneURL, payloadData, function (response) {
        if (response.ErrorCode) {
          onError(commonFns.loginRadiusErrorTojsError(response));
        } else {
          commonFns.verifyOTP(formattedData + '&onetouchloginflag=true', container, onSuccess, onError, _classPrefix, '', refield);
          commonFns.resendOTP(formattedData + '&onetouchloginflag=true', container, onSuccess, onError, _classPrefix, '', refield);
        }
      }, 'oneTouchLogin');
    } else {
      // eslint-disable-next-line no-magic-numbers
      ...
      if (useUpdatedAPI) {
        ...
        oneTouchEmailURL = oneTouchEmailURL + '&' + formattedData + '&clientGuid=' + clientGuid;
      }

      module.util.ajaxCall(method, oneTouchEmailURL, payloadData, function (response) {
        if (response.ErrorCode) {
          onError(commonFns.loginRadiusErrorTojsError(response));
        } else {
            ...
            if (((isphone || !phonereq) && (isemail || !emailreq)) || ((isphone || !phonereq) && (module.options.disabledEmailVerification || module.options.optionalEmailVerification))) {
              ...
              if (userProfile.Email != null && !userProfile.EmailVerified) {
                ...
                var _onSuccess = function () {
                  ...
                  commonFns.resendOTP('phone=' + userProfile.PhoneId + '&noPhoneVerified=false', container, onSuccess, onError, _classPrefix);
                };
                var recaptchaid = _classPrefix + LoginRadiusDefaults.idPrefix + 'recaptcha_widget_verifyotp';
                controllersModule.resendOTPController(phoneObj, _onSuccess, onError, recaptchaid, container, _classPrefix);
              }
  ...
  */
  controllersModule.accountLinkingReceiveToken = function (tok, onSuccess, onError) {
    if (module.options.noCallbackForSocialLogin) {
      module.util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/socialidentity?apiKey=' + module.options.apiKey + '&access_token=' + tok, '', function (responseObject) {
        if (responseObject.ErrorCode) {
          onError(commonFns.loginRadiusErrorTojsError(responseObject));
        } else if (responseObject.Uid !== module.storage.getBrowserStorage(LoginRadiusDefaults.storedUidName)) {
          module.util.ajaxCall('put', LoginRadiusDefaults.apiDomain + '/auth/socialidentity?apiKey=' + module.options.apiKey + '&access_token=' + module.storage.getBrowserStorage(LoginRadiusDefaults.storedTokenName), 'candidatetoken=' + tok, function (response) {
            if (response.ErrorCode) {
              onError(commonFns.loginRadiusErrorTojsError(response));
            } else {
              onSuccess(response);
...
var LoginRadiusV2 = function (lrOptions) {
  ...
  */
  function passwordlessLoginVerification (vtoken, onSuccess, onError, _classPrefix) {
    if (vtoken) {
      var method = 'get';
      var body = '';
      ...
      if (module.options.otpEmailVerification) {
        var email = util.getQueryParameterByName('email');
        body = {
          'email': email ? email.replace(/ /g, '+') : '',
          'otp': vtoken,
          'welcomeemailtemplate': module.options.welcomeEmailTemplate
        };
        method = 'post';
        url = LoginRadiusDefaults.apiDomain + '/auth/login/passwordlesslogin/email/verifyotp?apiKey=' + module.options.apiKey;
      }
      util.ajaxCall(method, url, body, function (response) {
        if (response.ErrorCode) {
          onError(commonFns.loginRadiusErrorTojsError(response));
        } else {
          commonFns.loginHandleToken(response, '', onSuccess, onError, _classPrefix);
        }
      }, 'passwordlessLogin');
    }
  }
  ...
  */
  function passwordlessLogin (onSuccess, onError, _classPrefix) {
    ...
    if ((vtype === 'oneclicksignin' || vtype === 'passwordlesslogin') && !module.passwordlessLoginFlag) {
      ...
      passwordlessLoginVerification(vtoken, onSuccess, onError, _classPrefix);
    }
  }
    ...
    var renderLoginForm = function (schema, actionName) {
      commonFns.createForm(schema, actionName, container, function (loginData) {
        ...
        if (window['lrpasswordlesslogin']) {
          commonFns.sendInstantSignInLink(loginData, onSuccess, onError, container, _classPrefix);
        } else if (window['lrpasswordlessloginotp']) {
          commonFns.sendInstantSignInOtp(loginData, onSuccess, onError, container, _classPrefix);
          // controllers.loginOTPController(loginData, container, onSuccess, onError, _classPrefix);
        } else {
    ...
    commonFns.createForm(regSchema, 'registration', container, function (data) {
      ...
      if (errors.length > 0) {
        ...
        controllers.registrationController(data, container, function (loginResponse, formData) {
          if (window.grecaptcha && module.options.v2Recaptcha) {
            grecaptcha.reset(window[recaptchaid + 'lr_recaptcha_widgets_idprefix']);
          }
  ...
  * @param {Function} onSuccess success callback function
  * @param {Function} onError error callback function
  * @description This function will Confirm delete User.
  */
  function deleteUserConfirm (onSuccess, onError) {
    var vtoken = util.getHashParam('vtoken');
  ...
  */
  function backupCodeButton (container, onSuccess, onError, _classPrefix) {
    util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/account/2FA?apikey=' + module.options.apiKey + '&access_token=' + module.storage.getBrowserStorage(LoginRadiusDefaults.storedTokenName), '', function (response) {
      if (response.IsSecurityQuestionAuthenticatorVerified || response.IsEmailOtpAuthenticatorVerified || response.IsOTPAuthenticatorVerified || response.IsGoogleAuthenticatorVerified) {
      ...
      if (!module.options.optionalTwoFactorAuthentication && !module.options.twoFactorAuthentication) {
        ...
        util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/account/2FA?apikey=' + module.options.apiKey + '&access_token=' + module.storage.getBrowserStorage(LoginRadiusDefaults.storedTokenName), '', function (response) {
          ...
          if (response.ErrorCode) {
            ...
            module.storage.setBrowserStorage(LoginRadiusDefaults.storedGAAuth, response.IsGoogleAuthenticatorVerified);
            ...
            var twoFAAccountemailotpCodeFn = function () {
              if (module.options.emailOTPAuthentication && response.Email && response.Email.length) {
                if (!response.IsEmailOtpAuthenticatorVerified) {
                  ...
                  disableMFA = (updatedOtpAuth !== 'false' || gAuth !== 'false' || sqAuth !== 'false');
            ...
            var twoFAAccountsecurityquestionCodeFn = function () {
              if (module.options.securityQuestionAuthentication) {
                if (!response.IsSecurityQuestionAuthenticatorVerified) {
                  ...
                  disableMFA = (updatedOtpAuth !== 'false' || emailotpAuth !== 'false' || gAuth !== 'false');
                  if ((disableMFA && module.options.twoFactorAuthentication) || module.options.optionalTwoFactorAuthentication) {
            ...
            var twoFAAccountgoogleauthCodeFn = function () {
              if (module.options.googleAuthentication) {
                // LoginRadiusDefaults.innerHTML = true;
                if (!response.IsGoogleAuthenticatorVerified) {
                  var googleAuthenticatorBtn = module.util.getButtonAttribute('googleauthenticator', _classPrefix, function () {
                    LoginRadiusDefaults.innerHTML = false;
                  ...
                  disableMFA = updatedOtpAuth !== 'false' || emailotpAuth !== 'false' || sqAuth !== 'false';
                  ...
                  if ((disableMFA && module.options.twoFactorAuthentication) || module.options.optionalTwoFactorAuthentication) {
                    ...
                    module.util.addEvent('click', disableGAAuth, function (event) {
                      commonFns.disableMFAOptions('googleauthenticator', onSuccess, onError);
                    });
                  }
                }
                // commonFns.showQRCode(response, container, onSuccess, onError, _classPrefix);
            ...
            if (response.EmailVerified || response.PhoneIdVerified) {
              ...
              if (!module.options.isMobile && !module.options.noCallbackForSocialLogin) {
                util.addEvent('message', window, function (event) {
                  ...
                  if (typeof event.data === 'string' && _uuidFormat.test(event.data)) {
                ...
                module.$hooks.register('socialCalls', function (provider, clientGuid) {
                  if (module.options.noCallbackForSocialLogin) {
                    var onHandleSocialLoginSuccess = function (resp) {
                      if (resp.access_token) {
                        controllers.accountLinkingReceiveToken(resp.access_token, onSuccess, onError);
                      } else {
                        onSuccess(resp);
                      }
                    };
                    commonFns.pingForSocialLogin(clientGuid, onHandleSocialLoginSuccess, function () { /* do nothing. */ });
                  }
                });
              }
            } else {
  ...
  */
  function oneTouchLogin (container, onSuccess, onError, classPrefix) {
    var vtoken = util.getHashParam('vtoken');
    var vtype = util.getHashParam('vtype');
    var useUpdatedAPI = false;
    var captchaEnabled = module.options.v2Recaptcha || module.options.invisibleRecaptcha || module.options.tencentCaptcha || module.options.tencentCaptchaAsFallback;
    if (captchaEnabled) {
      useUpdatedAPI = true;
    } else if (module.options.privacyPolicyConfiguration.IsEnabled) {
    ...
    if (vtype === 'noregistration' || vtype === 'onetouchlogin') {
      oneTouchLoginEmailVerification(vtoken, onSuccess, onError);
    }
    ...
    if (useUpdatedAPI) {
      util.addRecaptchaJS();
      recaptchaId = classPrefix + LoginRadiusDefaults.idPrefix + container;
      util.captchaSchema(recaptchaId, schema);
    }
    commonFns.createForm(schema, 'oneTouchLogin', container, function (data) {
      controllers.oneTouchLoginController(data, container, onSuccess, onError, classPrefix, useUpdatedAPI);
    }, function (error) {
      onError(error);
    }, classPrefix);
    if (useUpdatedAPI) {
  ...
  */
  function oneTouchLoginEmailVerification (vtoken, onSuccess, onError) {
    if (vtoken) {
      util.ajaxCall('get', LoginRadiusDefaults.apiDomain + '/auth/email/autologin?apiKey=' + module.options.apiKey + '&verificationtoken=' + vtoken + '&welcomeEmailTemplate=' + module.options.welcomeEmailTemplate, '', function (response) {
        if (response.ErrorCode) {
          onError(commonFns.loginRadiusErrorTojsError(response));
        } else {
          commonFns.loginHandleToken(response, '', onSuccess, onError);
  ...
  module.init = function (action, options) {
	...
	if(action === "organization"){
		if (!module.currentActionOptions) {
		 ...
		 module.currentActionOptions['organization'] = {};
		  module.currentActionOptions['organization']['onSuccess'] = options.onSuccess || function () { /* do nothing. */ };;
		  module.currentActionOptions['organization']['container'] = options.container || '';
        module.currentActionOptions['organization']['onError'] = options.onError || function () { /* do nothing. */ };
        module.currentActionOptions['organization']['classPrefix'] = options._classPrefix || '';
	}
